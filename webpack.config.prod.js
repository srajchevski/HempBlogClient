...
module.exports = validate({
    ...
    module: {
        loaders: [
            ...
            // { test: /\.svg(\?.*)?$/, include: [path.join(__dirname, './public/img'), path.join(__dirname, './public/fonts'), path.join(__dirname, './public/css')],  loader: 'url?prefix=fonts/&name=[path][name].[ext]&limit=10000&mimetype=image/svg+xml' },
            // {
